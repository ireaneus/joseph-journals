...
Note carefully what the Article actually confesses: man *cannot turn himself*. The Wesleyan system takes that grace which "prevents us" and universalizes it — teaching, as Wesley argued in his sermon "On Working Out Our Own Salvation," that a measure of this enabling grace is given to every person without exception, so that no sinner is finally unable to respond. That extension — grace made universal, salvation suspended on the sinner's choice — is the doctrine this article confronts.
...
Dort's Third and Fourth Heads of Doctrine (Articles 11–12) go on to describe this regenerating work as a new creation which God works in us without our aid — certain and effectual, because the power at work is the same power that raised Christ from the dead. The difference between the two doctrines is the difference between the whole article that follows: prevenient grace makes salvation possible; effectual grace saves.
...
- Repentance: Our response is a broken and contrite heart **(Psalm 51)**.
